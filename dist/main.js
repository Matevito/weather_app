...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/main.css */ \"./src/styles/main.css\");\n/* harmony import */ var _w_apis__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./w_apis */ \"./src/w_apis.js\");\n\n\n\n/*todo:\nlet gps_btn = document.getElementById(\"gps\");\n*/\n\nlet search_btn = document.getElementById(\"search\");\nsearch_btn.addEventListener(\"click\", () => {\n  let city_input = document.querySelector(\"input\").value;\n  (0,_w_apis__WEBPACK_IMPORTED_MODULE_1__.get_todayWeather)(city_input);\n});\n\n\n//# sourceURL=webpack://weather_app/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"get_todayWeather\": () => (/* binding */ get_todayWeather)\n/* harmony export */ });\n/* harmony import */ var _dom_manipulation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom_manipulation */ \"./src/dom_manipulation.js\");\n\n\nconst W_API_KEY = \"88d36c3bc23d2b771a07f19c1af0a6a3\";\n\nasync function get_todayWeather(city) {\n  const c_key =\n    \"http://api.openweathermap.org/data/2.5/weather?q=\" +\n    city +\n    \"&units=metric&appid=\" +\n    W_API_KEY;\n  const f_key =\n    \"http://api.openweathermap.org/data/2.5/weather?q=\" +\n    city +\n    \"&units=imperial&appid=\" +\n    W_API_KEY;\n\n  try {\n    _dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.dom_manipulation.clean_error();\n\n    //fetch data. if it fails throw and error with cod.404\n    let c_response = await fetch(c_key, { mode: \"cors\" });\n    if (!c_response.ok) throw new Error(\"Request failed.\");\n    let f_response = await fetch(f_key, { mode: \"cors\" });\n    if (!f_response.ok) throw new Error(\"Request failed.\");\n\n    let Cw_data = await c_response.json();\n    let fw_data = await f_response.json();\n    _dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.dom_manipulation.build_app(Cw_data, fw_data);\n  } catch (error) {\n    _dom_manipulation__WEBPACK_IMPORTED_MODULE_0__.dom_manipulation.print_error();\n  }\n}\n\n\n\n\n//# sourceURL=webpack://weather_app/./src/w_apis.js?");
